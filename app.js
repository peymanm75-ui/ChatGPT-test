...
const handlePubchemSearch = async () => {
  ...
  try {
    ...
    pubchemResult.textContent = "Unable to reach PubChem or NCI Cactus right now.";
  }
};
...
const answerVoiceQuery = async (query) => {
  ...
  try {
    ...
    voiceStatus.textContent = "Unable to reach PubChem or NCI Cactus for that request.";
    speak("I could not reach PubChem or NCI Cactus right now.");
  }
};
